...
vim.keymap.set('n', '[q', vim.diagnostic.get_prev)
vim.keymap.set('n', ']q', vim.diagnostic.get_next)
vim.keymap.set('n', 'C-wd', vim.diagnostic.open_float)
vim.keymap.set('n', '<leader>fd', '<cmd>Telescope diagnostics bufnr=0<CR>') -- fd for file diagnostics
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>fz', builtin.current_buffer_fuzzy_find, { desc = '[S]earch Recent Files ("." for repeat)' })
